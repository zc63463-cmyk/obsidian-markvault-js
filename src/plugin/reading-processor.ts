...
import { processNativeAnnotations, findNextContentElement } from './reading-native-processor';
// 🔧 Phase 5B: block/span 锚点标注处理提取到独立模块
import { processBlockAnchors, collectLeafBlocks, computeBlockStarts } from './reading-block-processor';
...
export class ReadingModeProcessor {
  ...
  // ─── 阅读模式渲染方法 ──────────────────────────────────────
  // 🔧 Phase 5B: block/span 锚点标注处理已提取到 reading-block-processor.ts
  // @see processBlockAnchors, applyBlockDecoration, applyBlockDecorationsFromSource,
  //      collectLeafBlocks, computeBlockStarts (imported from reading-block-processor)
   ...
   */
  /**
   * 🔧 Phase 5B: highlightSpanFragments 和 wrapTextFragments 已提取到 reading-block-processor.ts
   * @see highlightSpanFragments, wrapTextFragments (imported from reading-block-processor)
   */
}

/**
 * 🔧 Phase 5B: findNextContentElement 已提取到 reading-native-processor.ts
 * @see findNextContentElement (imported)
 */
